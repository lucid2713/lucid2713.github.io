...
<h4>Source Codes</h4>
<br/>
<strong>Arduino source code 1</strong>: Setting sound systems and the status of manikin
...
<strong>Arduino source code 2</strong>: Setting the LED color for the face of manikin
{% highlight c++ %}  
...
<strong>Arduino source code 3</strong>: Setting the pressure sensor of manikin
{% highlight c++ %}  
